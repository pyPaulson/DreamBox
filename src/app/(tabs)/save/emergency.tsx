    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <Text style={styles.emergencyText}>
          ...
          unexpected expenses or financial emergencies. It is typically used for
          things like medical bills, car repairs, or job loss. The goal of an
          emergency fund is to provide a financial safety net that can help you
